        ...
        <header class="border-b border-slate-200 bg-white">
            <div class="pf-container flex min-h-18 items-center justify-between gap-4 py-3">
                ...
                <nav class="hidden items-center gap-2 lg:flex">
                    ...
                    <a href="{{ route('admin.downloads.index') }}" class="rounded px-3 py-2 text-sm font-semibold transition {{ request()->routeIs('admin.downloads.*') ? 'bg-cyan-50 text-[#0579a7]' : 'text-slate-600 hover:bg-slate-100' }}">{{ __('admin.downloads.title') }}</a>
            ...
            <nav id="pf-mobile-menu" class="hidden border-t border-slate-200/80 bg-white lg:hidden">
                <div class="pf-container flex flex-col py-1">
                    ...
                    <a href="{{ route('admin.downloads.index') }}" class="border-b border-slate-100 px-4 py-3 text-sm font-semibold transition {{ request()->routeIs('admin.downloads.*') ? 'bg-cyan-50 text-[#0579a7]' : 'text-slate-700 hover:bg-cyan-50' }}">{{ __('admin.downloads.title') }}</a>
