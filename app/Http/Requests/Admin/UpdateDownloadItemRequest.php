...
class UpdateDownloadItemRequest extends FormRequest
{
    ...
    private function validateDownloadSource(Validator $validator): void
    {
        ...
        $hasExistingFile = $download instanceof DownloadItem && (bool) $download->file_path;
        ...
        if (in_array($type, [DownloadItem::TYPE_PDF, DownloadItem::TYPE_ARCHIVE, DownloadItem::TYPE_FILE], true) && ! $hasUrl && ! $hasFile && ! $hasExistingFile) {
